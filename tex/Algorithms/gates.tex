\begin{topic}{hadamard-gate}{Hadamard gate}
    The \emph{Hadamard gate} is the \tref{GEN:qubit}{$1$-qubit} gate $H$ given by
    \[ \begin{aligned}
...
\begin{topic}{cnot-gate}{CNOT gate}
    The \emph{CNOT gate} is the \tref{GEN:qubit}{$2$-qubit} gate given by
    \[ \begin{aligned}
...
\begin{topic}{toffoli-gate}{Toffoli gate}
    The \emph{Toffoli gate}, also known as the \emph{CCNOT gate}, is the \tref{GEN:qubit}{$3$-qubit} gate $T$ given by
    \[ \begin{aligned}
